...
COMMENT ON COLUMN work_overlap_contract_engineers.engineer_id IS '기술자ID';
...
COMMENT ON COLUMN work_overlap_contract_engineer_histories.before_engineer_id IS '변경전 기술자ID';
COMMENT ON COLUMN work_overlap_contract_engineer_histories.after_engineer_id IS '변경후 기술자ID';
