...
public interface EngineerMasterJpaRepository extends JpaRepository<EngineerMasterEntity, String> {
    ...
    boolean existsDuplicate(
            @Param("nameKor") String nameKor,
            @Param("birthday") String birthday,
            @Param("excludeEngrId") String excludeEngrId
    );
    ...
    @Query("""
            ...
            """)
    List<EngineerCandidate> findCompanyPerformanceCandidates(
    ...
    @Query("""
            ...
            where (:retireYn = ''
              ...
              and (:certificationName = '' or exists (
                   select license.id from EngineerLicenseEntity license
                   where license.engrId = e.engrId
                     and (lower(license.licenseCode) like lower(concat('%', :certificationName, '%'))
                          or lower(license.licenseNo) like lower(concat('%', :certificationName, '%')))))
